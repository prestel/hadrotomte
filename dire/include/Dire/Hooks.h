...
public:
  ...
  virtual bool doLoadFSRKernels( std::unordered_map< string, DireSplitting* >&) {return false;}
  virtual bool canLoadISRKernels() {return false;}
  virtual bool doLoadISRKernels( std::unordered_map< string, DireSplitting* >&) {return false;}
