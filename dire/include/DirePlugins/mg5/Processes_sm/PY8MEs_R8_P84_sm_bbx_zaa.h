...
#ifndef PY8MEs_R8_P84_sm_bbx_zaa_H
#define PY8MEs_R8_P84_sm_bbx_zaa_H
...
class PY8MEs_R8_P84_sm_bbx_zaa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P84_sm_bbx_zaa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P84_sm_bbx_zaa(); 
    ...
    virtual string name() const {return "bbx_zaa (sm)";}

    virtual int code() const {return 10884;}
...
#endif  // PY8MEs_R8_P84_sm_bbx_zaa_H
