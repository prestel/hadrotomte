...
#ifndef PY8MEs_R2_P49_sm_bb_bb_H
#define PY8MEs_R2_P49_sm_bb_bb_H
...
class PY8MEs_R2_P49_sm_bb_bb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P49_sm_bb_bb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P49_sm_bb_bb(); 
    ...
    virtual string name() const {return "bb_bb (sm)";}

    virtual int code() const {return 10249;}
  ...
  private:
    ...
    double matrix_2_bb_bb(); 
    double matrix_2_bbx_bbx(); 
    double matrix_2_bxbx_bxbx(); 
...
#endif  // PY8MEs_R2_P49_sm_bb_bb_H
