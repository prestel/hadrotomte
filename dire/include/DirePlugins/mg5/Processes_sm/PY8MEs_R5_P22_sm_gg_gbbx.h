...
#ifndef PY8MEs_R5_P22_sm_gg_gbbx_H
#define PY8MEs_R5_P22_sm_gg_gbbx_H
...
class PY8MEs_R5_P22_sm_gg_gbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P22_sm_gg_gbbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P22_sm_gg_gbbx(); 
    ...
    virtual string name() const {return "gg_gbbx (sm)";}

    virtual int code() const {return 10522;}
...
#endif  // PY8MEs_R5_P22_sm_gg_gbbx_H
