...
#ifndef PY8MEs_R2_P102_sm_gq_qa_H
#define PY8MEs_R2_P102_sm_gq_qa_H
...
class PY8MEs_R2_P102_sm_gq_qa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P102_sm_gq_qa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P102_sm_gq_qa(); 
    ...
    virtual string name() const {return "gq_qa (sm)";}

    virtual int code() const {return 10302;}
  ...
  private:
    ...
    double matrix_2_gu_ua(); 
    double matrix_2_gd_da(); 
    double matrix_2_gux_uxa(); 
    double matrix_2_gdx_dxa(); 
...
#endif  // PY8MEs_R2_P102_sm_gq_qa_H
