...
#ifndef PY8MEs_R7_P17_sm_gb_llab_H
#define PY8MEs_R7_P17_sm_gb_llab_H
...
class PY8MEs_R7_P17_sm_gb_llab : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P17_sm_gb_llab(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P17_sm_gb_llab(); 
    ...
    virtual string name() const {return "gb_llab (sm)";}

    virtual int code() const {return 10717;}
  ...
  private:
    ...
    static const int nwavefuncs = 37; 
    Complex<double> w[nwavefuncs][18]; 
    static const int namplitudes = 52; 
    Complex<double> amp[namplitudes]; 
    double matrix_7_gb_emepab(); 
    double matrix_7_gbx_emepabx(); 
    double matrix_7_gb_vevexab(); 
    double matrix_7_gbx_vevexabx(); 
...
#endif  // PY8MEs_R7_P17_sm_gb_llab_H
