...
#ifndef PY8MEs_R8_P48_sm_bbx_zll_H
#define PY8MEs_R8_P48_sm_bbx_zll_H
...
class PY8MEs_R8_P48_sm_bbx_zll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P48_sm_bbx_zll(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P48_sm_bbx_zll(); 
    ...
    virtual string name() const {return "bbx_zll (sm)";}

    virtual int code() const {return 10848;}
  ...
  private:
    ...
    double matrix_8_bbx_zemep(); 
    double matrix_8_bbx_zvevex(); 
...
#endif  // PY8MEs_R8_P48_sm_bbx_zll_H
