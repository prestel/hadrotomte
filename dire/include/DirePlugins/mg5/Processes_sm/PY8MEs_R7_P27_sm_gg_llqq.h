...
#ifndef PY8MEs_R7_P27_sm_gg_llqq_H
#define PY8MEs_R7_P27_sm_gg_llqq_H
...
class PY8MEs_R7_P27_sm_gg_llqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P27_sm_gg_llqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P27_sm_gg_llqq(); 
    ...
    virtual string name() const {return "gg_llqq (sm)";}

    virtual int code() const {return 10727;}
  ...
  private:
    ...
    double matrix_7_gg_emepuux(); 
    double matrix_7_gg_emepddx(); 
    double matrix_7_gg_emvexudx(); 
    double matrix_7_gg_veepdux(); 
    double matrix_7_gg_vevexuux(); 
    double matrix_7_gg_vevexddx(); 
...
#endif  // PY8MEs_R7_P27_sm_gg_llqq_H
