...
#ifndef PY8MEs_R7_P32_sm_bbx_llgg_H
#define PY8MEs_R7_P32_sm_bbx_llgg_H
...
class PY8MEs_R7_P32_sm_bbx_llgg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P32_sm_bbx_llgg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P32_sm_bbx_llgg(); 
    ...
    virtual string name() const {return "bbx_llgg (sm)";}

    virtual int code() const {return 10732;}
  ...
  private:
    ...
    double matrix_7_bbx_emepgg(); 
    double matrix_7_bbx_vevexgg(); 
...
#endif  // PY8MEs_R7_P32_sm_bbx_llgg_H
