...
#ifndef PY8MEs_R8_P68_sm_qq_wpga_H
#define PY8MEs_R8_P68_sm_qq_wpga_H
...
class PY8MEs_R8_P68_sm_qq_wpga : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P68_sm_qq_wpga(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P68_sm_qq_wpga(); 
    ...
    virtual string name() const {return "qq_wpga (sm)";}

    virtual int code() const {return 10868;}
  ...
  private:
    ...
    double matrix_8_udx_wpga(); 
    double matrix_8_dux_wmga(); 
...
#endif  // PY8MEs_R8_P68_sm_qq_wpga_H
