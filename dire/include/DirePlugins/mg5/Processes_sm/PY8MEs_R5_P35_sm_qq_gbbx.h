...
#ifndef PY8MEs_R5_P35_sm_qq_gbbx_H
#define PY8MEs_R5_P35_sm_qq_gbbx_H
...
class PY8MEs_R5_P35_sm_qq_gbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P35_sm_qq_gbbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P35_sm_qq_gbbx(); 
    ...
    virtual string name() const {return "qq_gbbx (sm)";}

    virtual int code() const {return 10535;}
  ...
  private:
    ...
    double matrix_5_uux_gbbx(); 
    double matrix_5_ddx_gbbx(); 
...
#endif  // PY8MEs_R5_P35_sm_qq_gbbx_H
