...
#ifndef PY8MEs_R8_P83_sm_bbx_zga_H
#define PY8MEs_R8_P83_sm_bbx_zga_H
...
class PY8MEs_R8_P83_sm_bbx_zga : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P83_sm_bbx_zga(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P83_sm_bbx_zga(); 
    ...
    virtual string name() const {return "bbx_zga (sm)";}

    virtual int code() const {return 10883;}
...
#endif  // PY8MEs_R8_P83_sm_bbx_zga_H
