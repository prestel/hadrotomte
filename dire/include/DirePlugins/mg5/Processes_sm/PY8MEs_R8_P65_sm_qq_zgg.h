...
#ifndef PY8MEs_R8_P65_sm_qq_zgg_H
#define PY8MEs_R8_P65_sm_qq_zgg_H
...
class PY8MEs_R8_P65_sm_qq_zgg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P65_sm_qq_zgg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P65_sm_qq_zgg(); 
    ...
    virtual string name() const {return "qq_zgg (sm)";}

    virtual int code() const {return 10865;}
  ...
  private:
    ...
    double matrix_8_uux_zgg(); 
    double matrix_8_ddx_zgg(); 
...
#endif  // PY8MEs_R8_P65_sm_qq_zgg_H
