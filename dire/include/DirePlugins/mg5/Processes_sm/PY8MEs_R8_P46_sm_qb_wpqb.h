...
#ifndef PY8MEs_R8_P46_sm_qb_wpqb_H
#define PY8MEs_R8_P46_sm_qb_wpqb_H
...
class PY8MEs_R8_P46_sm_qb_wpqb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P46_sm_qb_wpqb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P46_sm_qb_wpqb(); 
    ...
    virtual string name() const {return "qb_wpqb (sm)";}

    virtual int code() const {return 10846;}
  ...
  private:
    ...
    static const int namplitudes = 75; 
    Complex<double> amp[namplitudes]; 
    double matrix_8_ub_wpdb(); 
    double matrix_8_ubx_wpdbx(); 
    double matrix_8_db_wmub(); 
    double matrix_8_dbx_wmubx(); 
    double matrix_8_uxb_wmdxb(); 
    double matrix_8_uxbx_wmdxbx(); 
    double matrix_8_dxb_wpuxb(); 
    double matrix_8_dxbx_wpuxbx(); 
...
#endif  // PY8MEs_R8_P46_sm_qb_wpqb_H
