...
#ifndef PY8MEs_R5_P77_sm_bbx_gaa_H
#define PY8MEs_R5_P77_sm_bbx_gaa_H
...
class PY8MEs_R5_P77_sm_bbx_gaa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P77_sm_bbx_gaa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P77_sm_bbx_gaa(); 
    ...
    virtual string name() const {return "bbx_gaa (sm)";}

    virtual int code() const {return 10577;}
...
#endif  // PY8MEs_R5_P77_sm_bbx_gaa_H
