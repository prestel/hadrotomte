...
#ifndef PY8MEs_R5_P13_sm_gg_ggg_H
#define PY8MEs_R5_P13_sm_gg_ggg_H
...
class PY8MEs_R5_P13_sm_gg_ggg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P13_sm_gg_ggg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P13_sm_gg_ggg(); 
    ...
    virtual int code() const {return 10513;}
...
#endif  // PY8MEs_R5_P13_sm_gg_ggg_H
