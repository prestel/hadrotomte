...
#ifndef PY8MEs_R5_P24_sm_gb_ggb_H
#define PY8MEs_R5_P24_sm_gb_ggb_H
...
class PY8MEs_R5_P24_sm_gb_ggb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P24_sm_gb_ggb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P24_sm_gb_ggb(); 
    ...
    virtual string name() const {return "gb_ggb (sm)";}

    virtual int code() const {return 10524;}
  ...
  private:
    ...
    double matrix_5_gb_ggb(); 
    double matrix_5_gbx_ggbx(); 
...
#endif  // PY8MEs_R5_P24_sm_gb_ggb_H
