...
#ifndef PY8MEs_R5_P44_sm_bbx_qqa_H
#define PY8MEs_R5_P44_sm_bbx_qqa_H
...
class PY8MEs_R5_P44_sm_bbx_qqa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P44_sm_bbx_qqa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P44_sm_bbx_qqa(); 
    ...
    virtual string name() const {return "bbx_qqa (sm)";}

    virtual int code() const {return 10544;}
  ...
  private:
    ...
    double matrix_5_bbx_uuxa(); 
    double matrix_5_bbx_ddxa(); 
...
#endif  // PY8MEs_R5_P44_sm_bbx_qqa_H
