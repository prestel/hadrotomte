...
#ifndef PY8MEs_R6_P99_sm_qq_wpa_H
#define PY8MEs_R6_P99_sm_qq_wpa_H
...
class PY8MEs_R6_P99_sm_qq_wpa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P99_sm_qq_wpa(Parameters_sm * model) : pars(model) {initProc();}
    ...
    virtual string name() const {return "qq_wpa (sm)";}

    virtual int code() const {return 10699;}
  ...
  private:
    ...
    double matrix_6_udx_wpa(); 
    double matrix_6_dux_wma(); 
...
#endif  // PY8MEs_R6_P99_sm_qq_wpa_H
