...
#ifndef PY8MEs_R2_P85_sm_gg_gg_H
#define PY8MEs_R2_P85_sm_gg_gg_H
...
class PY8MEs_R2_P85_sm_gg_gg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P85_sm_gg_gg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P85_sm_gg_gg(); 
    ...
    virtual int code() const {return 10285;}
...
#endif  // PY8MEs_R2_P85_sm_gg_gg_H
