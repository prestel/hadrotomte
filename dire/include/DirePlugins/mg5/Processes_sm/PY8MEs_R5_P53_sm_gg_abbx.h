...
#ifndef PY8MEs_R5_P53_sm_gg_abbx_H
#define PY8MEs_R5_P53_sm_gg_abbx_H
...
class PY8MEs_R5_P53_sm_gg_abbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P53_sm_gg_abbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P53_sm_gg_abbx(); 
    ...
    virtual string name() const {return "gg_abbx (sm)";}

    virtual int code() const {return 10553;}
...
#endif  // PY8MEs_R5_P53_sm_gg_abbx_H
