...
#ifndef PY8MEs_R8_P69_sm_bbx_zgg_H
#define PY8MEs_R8_P69_sm_bbx_zgg_H
...
class PY8MEs_R8_P69_sm_bbx_zgg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P69_sm_bbx_zgg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P69_sm_bbx_zgg(); 
    ...
    virtual string name() const {return "bbx_zgg (sm)";}

    virtual int code() const {return 10869;}
...
#endif  // PY8MEs_R8_P69_sm_bbx_zgg_H
