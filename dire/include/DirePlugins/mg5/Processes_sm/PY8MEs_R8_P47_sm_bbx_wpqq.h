...
#ifndef PY8MEs_R8_P47_sm_bbx_wpqq_H
#define PY8MEs_R8_P47_sm_bbx_wpqq_H
...
class PY8MEs_R8_P47_sm_bbx_wpqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P47_sm_bbx_wpqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P47_sm_bbx_wpqq(); 
    ...
    virtual string name() const {return "bbx_wpqq (sm)";}

    virtual int code() const {return 10847;}
  ...
  private:
    ...
    static const int namplitudes = 15; 
    Complex<double> amp[namplitudes]; 
    double matrix_8_bbx_wpdux(); 
    double matrix_8_bbx_wmudx(); 
...
#endif  // PY8MEs_R8_P47_sm_bbx_wpqq_H
