...
#ifndef PY8MEs_R6_P109_sm_gq_zq_H
#define PY8MEs_R6_P109_sm_gq_zq_H
...
class PY8MEs_R6_P109_sm_gq_zq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P109_sm_gq_zq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R6_P109_sm_gq_zq(); 
  ...
  private:
    ...
    double matrix_6_gu_zu(); 
    double matrix_6_gd_zd(); 
    double matrix_6_gux_zux(); 
    double matrix_6_gdx_zdx(); 
...
#endif  // PY8MEs_R6_P109_sm_gq_zq_H
