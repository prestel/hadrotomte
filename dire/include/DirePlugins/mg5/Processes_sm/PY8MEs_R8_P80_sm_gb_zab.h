...
#ifndef PY8MEs_R8_P80_sm_gb_zab_H
#define PY8MEs_R8_P80_sm_gb_zab_H
...
class PY8MEs_R8_P80_sm_gb_zab : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P80_sm_gb_zab(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P80_sm_gb_zab(); 
    ...
    virtual string name() const {return "gb_zab (sm)";}

    virtual int code() const {return 10880;}
  ...
  private:
    ...
    double matrix_8_gb_zab(); 
    double matrix_8_gbx_zabx(); 
...
#endif  // PY8MEs_R8_P80_sm_gb_zab_H
