...
#ifndef PY8MEs_R8_P66_sm_qq_zll_H
#define PY8MEs_R8_P66_sm_qq_zll_H
...
class PY8MEs_R8_P66_sm_qq_zll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P66_sm_qq_zll(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P66_sm_qq_zll(); 
    ...
    virtual string name() const {return "qq_zll (sm)";}

    virtual int code() const {return 10866;}
  ...
  private:
    ...
    static const int namplitudes = 34; 
    Complex<double> amp[namplitudes]; 
    double matrix_8_uux_zemep(); 
    double matrix_8_ddx_zemep(); 
    double matrix_8_udx_zveep(); 
    double matrix_8_dux_zemvex(); 
    double matrix_8_uux_zvevex(); 
    double matrix_8_ddx_zvevex(); 
...
#endif  // PY8MEs_R8_P66_sm_qq_zll_H
