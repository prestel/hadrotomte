...
#ifndef PY8MEs_R5_P11_sm_gq_qqq_H
#define PY8MEs_R5_P11_sm_gq_qqq_H
...
class PY8MEs_R5_P11_sm_gq_qqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P11_sm_gq_qqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P11_sm_gq_qqq(); 
    ...
    virtual string name() const {return "gq_qqq (sm)";}

    virtual int code() const {return 10511;}
  ...
  private:
    ...
    static const int nwavefuncs = 55; 
    Complex<double> w[nwavefuncs][18]; 
    static const int namplitudes = 282; 
    Complex<double> amp[namplitudes]; 
    double matrix_5_gu_uuux(); 
    double matrix_5_gd_dddx(); 
    double matrix_5_gux_uuxux(); 
    double matrix_5_gdx_ddxdx(); 
    double matrix_5_gu_uddx(); 
    double matrix_5_gd_udux(); 
    double matrix_5_gux_duxdx(); 
    double matrix_5_gdx_uuxdx(); 
    double matrix_5_gu_uccx(); 
    double matrix_5_gu_ussx(); 
    double matrix_5_gd_cdcx(); 
    double matrix_5_gd_dssx(); 
    double matrix_5_gux_cuxcx(); 
    double matrix_5_gux_suxsx(); 
    double matrix_5_gdx_ccxdx(); 
    double matrix_5_gdx_sdxsx(); 
    double matrix_5_gu_cdsx(); 
    double matrix_5_gd_uscx(); 
    double matrix_5_gux_scxdx(); 
    double matrix_5_gdx_cuxsx(); 
...
#endif  // PY8MEs_R5_P11_sm_gq_qqq_H
