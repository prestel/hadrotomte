...
#ifndef PY8MEs_R6_P115_sm_bbx_za_H
#define PY8MEs_R6_P115_sm_bbx_za_H
...
class PY8MEs_R6_P115_sm_bbx_za : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P115_sm_bbx_za(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R6_P115_sm_bbx_za(); 
    ...
    virtual string name() const {return "bbx_za (sm)";}

    virtual int code() const {return 10715;}
...
#endif  // PY8MEs_R6_P115_sm_bbx_za_H
