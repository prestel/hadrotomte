...
#ifndef PY8MEs_R1_P100_sm_qq_ll_H
#define PY8MEs_R1_P100_sm_qq_ll_H
...
class PY8MEs_R1_P100_sm_qq_ll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R1_P100_sm_qq_ll(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R1_P100_sm_qq_ll(); 
    ...
    virtual string name() const {return "qq_ll (sm)";}

    virtual int code() const {return 10200;}
  ...
  private:
    ...
    double matrix_1_uux_emep(); 
    double matrix_1_ddx_emep(); 
    double matrix_1_uux_vevex(); 
    double matrix_1_udx_veep(); 
    double matrix_1_dux_emvex(); 
    double matrix_1_ddx_vevex(); 
...
#endif  // PY8MEs_R1_P100_sm_qq_ll_H
