...
#ifndef PY8MEs_R7_P19_sm_bbx_llga_H
#define PY8MEs_R7_P19_sm_bbx_llga_H
...
class PY8MEs_R7_P19_sm_bbx_llga : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P19_sm_bbx_llga(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P19_sm_bbx_llga(); 
    ...
    virtual string name() const {return "bbx_llga (sm)";}

    virtual int code() const {return 10719;}
  ...
  private:
    ...
    static const int namplitudes = 26; 
    Complex<double> amp[namplitudes]; 
    double matrix_7_bbx_emepga(); 
    double matrix_7_bbx_vevexga(); 
...
#endif  // PY8MEs_R7_P19_sm_bbx_llga_H
