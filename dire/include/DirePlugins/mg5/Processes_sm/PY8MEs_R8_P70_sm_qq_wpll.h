...
#ifndef PY8MEs_R8_P70_sm_qq_wpll_H
#define PY8MEs_R8_P70_sm_qq_wpll_H
...
class PY8MEs_R8_P70_sm_qq_wpll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P70_sm_qq_wpll(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P70_sm_qq_wpll(); 
    ...
    virtual string name() const {return "qq_wpll (sm)";}

    virtual int code() const {return 10870;}
  ...
  private:
    ...
    double matrix_8_udx_wpemep(); 
    double matrix_8_dux_wmemep(); 
    double matrix_8_uux_wpemvex(); 
    double matrix_8_uux_wmveep(); 
    double matrix_8_ddx_wpemvex(); 
    double matrix_8_ddx_wmveep(); 
    double matrix_8_udx_wpvevex(); 
    double matrix_8_dux_wmvevex(); 
...
#endif  // PY8MEs_R8_P70_sm_qq_wpll_H
