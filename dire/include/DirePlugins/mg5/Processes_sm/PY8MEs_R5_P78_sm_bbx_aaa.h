...
#ifndef PY8MEs_R5_P78_sm_bbx_aaa_H
#define PY8MEs_R5_P78_sm_bbx_aaa_H
...
class PY8MEs_R5_P78_sm_bbx_aaa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P78_sm_bbx_aaa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P78_sm_bbx_aaa(); 
    ...
    virtual string name() const {return "bbx_aaa (sm)";}

    virtual int code() const {return 10578;}
...
#endif  // PY8MEs_R5_P78_sm_bbx_aaa_H
