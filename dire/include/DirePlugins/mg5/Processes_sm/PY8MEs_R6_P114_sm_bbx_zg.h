...
#ifndef PY8MEs_R6_P114_sm_bbx_zg_H
#define PY8MEs_R6_P114_sm_bbx_zg_H
...
class PY8MEs_R6_P114_sm_bbx_zg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P114_sm_bbx_zg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R6_P114_sm_bbx_zg(); 
    ...
    virtual string name() const {return "bbx_zg (sm)";}

    virtual int code() const {return 10714;}
...
#endif  // PY8MEs_R6_P114_sm_bbx_zg_H
