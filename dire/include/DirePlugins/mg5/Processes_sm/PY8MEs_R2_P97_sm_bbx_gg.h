...
#ifndef PY8MEs_R2_P97_sm_bbx_gg_H
#define PY8MEs_R2_P97_sm_bbx_gg_H
...
class PY8MEs_R2_P97_sm_bbx_gg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P97_sm_bbx_gg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P97_sm_bbx_gg(); 
    ...
    virtual string name() const {return "bbx_gg (sm)";}

    virtual int code() const {return 10297;}
...
#endif  // PY8MEs_R2_P97_sm_bbx_gg_H
