...
#ifndef PY8MEs_R7_P29_sm_gq_llgq_H
#define PY8MEs_R7_P29_sm_gq_llgq_H
...
class PY8MEs_R7_P29_sm_gq_llgq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P29_sm_gq_llgq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P29_sm_gq_llgq(); 
    ...
    virtual string name() const {return "gq_llgq (sm)";}

    virtual int code() const {return 10729;}
  ...
  private:
    ...
    static const int namplitudes = 128; 
    Complex<double> amp[namplitudes]; 
    double matrix_7_gu_emepgu(); 
    double matrix_7_gd_emepgd(); 
    double matrix_7_gux_emepgux(); 
    double matrix_7_gdx_emepgdx(); 
    double matrix_7_gu_veepgd(); 
    double matrix_7_gu_vevexgu(); 
    double matrix_7_gd_emvexgu(); 
    double matrix_7_gd_vevexgd(); 
    double matrix_7_gux_emvexgdx(); 
    double matrix_7_gux_vevexgux(); 
    double matrix_7_gdx_veepgux(); 
    double matrix_7_gdx_vevexgdx(); 
...
#endif  // PY8MEs_R7_P29_sm_gq_llgq_H
