...
#ifndef PY8MEs_R8_P41_sm_bbx_zqq_H
#define PY8MEs_R8_P41_sm_bbx_zqq_H
...
class PY8MEs_R8_P41_sm_bbx_zqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P41_sm_bbx_zqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P41_sm_bbx_zqq(); 
    ...
    virtual string name() const {return "bbx_zqq (sm)";}

    virtual int code() const {return 10841;}
  ...
  private:
    ...
    double matrix_8_bbx_zuux(); 
    double matrix_8_bbx_zddx(); 
...
#endif  // PY8MEs_R8_P41_sm_bbx_zqq_H
