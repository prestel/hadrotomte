...
#ifndef PY8MEs_R8_P39_sm_qq_wpaa_H
#define PY8MEs_R8_P39_sm_qq_wpaa_H
...
class PY8MEs_R8_P39_sm_qq_wpaa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P39_sm_qq_wpaa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P39_sm_qq_wpaa(); 
    ...
    virtual string name() const {return "qq_wpaa (sm)";}

    virtual int code() const {return 10839;}
  ...
  private:
    ...
    double matrix_8_udx_wpaa(); 
    double matrix_8_dux_wmaa(); 
...
#endif  // PY8MEs_R8_P39_sm_qq_wpaa_H
