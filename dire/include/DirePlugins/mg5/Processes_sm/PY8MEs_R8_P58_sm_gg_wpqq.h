...
#ifndef PY8MEs_R8_P58_sm_gg_wpqq_H
#define PY8MEs_R8_P58_sm_gg_wpqq_H
...
class PY8MEs_R8_P58_sm_gg_wpqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P58_sm_gg_wpqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P58_sm_gg_wpqq(); 
    ...
    virtual string name() const {return "gg_wpqq (sm)";}

    virtual int code() const {return 10858;}
  ...
  private:
    ...
    double matrix_8_gg_wpdux(); 
    double matrix_8_gg_wmudx(); 
...
#endif  // PY8MEs_R8_P58_sm_gg_wpqq_H
