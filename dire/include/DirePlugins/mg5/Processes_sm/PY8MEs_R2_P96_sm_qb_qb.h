...
#ifndef PY8MEs_R2_P96_sm_qb_qb_H
#define PY8MEs_R2_P96_sm_qb_qb_H
...
class PY8MEs_R2_P96_sm_qb_qb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P96_sm_qb_qb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P96_sm_qb_qb(); 
    ...
    virtual string name() const {return "qb_qb (sm)";}

    virtual int code() const {return 10296;}
  ...
  private:
    ...
    static const int namplitudes = 23; 
    Complex<double> amp[namplitudes]; 
    double matrix_2_ub_ub(); 
    double matrix_2_ubx_ubx(); 
    double matrix_2_db_db(); 
    double matrix_2_dbx_dbx(); 
    double matrix_2_uxb_uxb(); 
    double matrix_2_uxbx_uxbx(); 
    double matrix_2_dxb_dxb(); 
    double matrix_2_dxbx_dxbx(); 
...
#endif  // PY8MEs_R2_P96_sm_qb_qb_H
