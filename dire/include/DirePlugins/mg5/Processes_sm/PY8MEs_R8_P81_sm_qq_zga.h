...
#ifndef PY8MEs_R8_P81_sm_qq_zga_H
#define PY8MEs_R8_P81_sm_qq_zga_H
...
class PY8MEs_R8_P81_sm_qq_zga : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P81_sm_qq_zga(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P81_sm_qq_zga(); 
    ...
    virtual string name() const {return "qq_zga (sm)";}

    virtual int code() const {return 10881;}
  ...
  private:
    ...
    double matrix_8_uux_zga(); 
    double matrix_8_ddx_zga(); 
...
#endif  // PY8MEs_R8_P81_sm_qq_zga_H
