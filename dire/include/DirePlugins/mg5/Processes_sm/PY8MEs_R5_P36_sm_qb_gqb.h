...
#ifndef PY8MEs_R5_P36_sm_qb_gqb_H
#define PY8MEs_R5_P36_sm_qb_gqb_H
...
class PY8MEs_R5_P36_sm_qb_gqb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P36_sm_qb_gqb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P36_sm_qb_gqb(); 
    ...
    virtual string name() const {return "qb_gqb (sm)";}

    virtual int code() const {return 10536;}
  ...
  private:
    ...
    double matrix_5_ub_gub(); 
    double matrix_5_ubx_gubx(); 
    double matrix_5_db_gdb(); 
    double matrix_5_dbx_gdbx(); 
    double matrix_5_uxb_guxb(); 
    double matrix_5_uxbx_guxbx(); 
    double matrix_5_dxb_gdxb(); 
    double matrix_5_dxbx_gdxbx(); 
...
#endif  // PY8MEs_R5_P36_sm_qb_gqb_H
