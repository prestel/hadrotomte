...
#ifndef PY8MEs_R5_P43_sm_qb_qab_H
#define PY8MEs_R5_P43_sm_qb_qab_H
...
class PY8MEs_R5_P43_sm_qb_qab : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P43_sm_qb_qab(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P43_sm_qb_qab(); 
    ...
    virtual string name() const {return "qb_qab (sm)";}

    virtual int code() const {return 10543;}
  ...
  private:
    ...
    static const int namplitudes = 94; 
    Complex<double> amp[namplitudes]; 
    double matrix_5_ub_uab(); 
    double matrix_5_ubx_uabx(); 
    double matrix_5_db_dab(); 
    double matrix_5_dbx_dabx(); 
    double matrix_5_uxb_uxab(); 
    double matrix_5_uxbx_uxabx(); 
    double matrix_5_dxb_dxab(); 
    double matrix_5_dxbx_dxabx(); 
...
#endif  // PY8MEs_R5_P43_sm_qb_qab_H
