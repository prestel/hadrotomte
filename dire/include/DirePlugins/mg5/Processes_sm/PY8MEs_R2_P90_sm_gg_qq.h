...
#ifndef PY8MEs_R2_P90_sm_gg_qq_H
#define PY8MEs_R2_P90_sm_gg_qq_H
...
class PY8MEs_R2_P90_sm_gg_qq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P90_sm_gg_qq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P90_sm_gg_qq(); 
    ...
    virtual int code() const {return 10290;}
...
#endif  // PY8MEs_R2_P90_sm_gg_qq_H
