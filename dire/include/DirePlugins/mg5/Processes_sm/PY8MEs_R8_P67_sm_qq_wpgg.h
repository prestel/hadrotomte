...
#ifndef PY8MEs_R8_P67_sm_qq_wpgg_H
#define PY8MEs_R8_P67_sm_qq_wpgg_H
...
class PY8MEs_R8_P67_sm_qq_wpgg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P67_sm_qq_wpgg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P67_sm_qq_wpgg(); 
    ...
    virtual string name() const {return "qq_wpgg (sm)";}

    virtual int code() const {return 10867;}
  ...
  private:
    ...
    double matrix_8_udx_wpgg(); 
    double matrix_8_dux_wmgg(); 
...
#endif  // PY8MEs_R8_P67_sm_qq_wpgg_H
