...
#ifndef PY8MEs_R8_P38_sm_qq_zbbx_H
#define PY8MEs_R8_P38_sm_qq_zbbx_H
...
class PY8MEs_R8_P38_sm_qq_zbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P38_sm_qq_zbbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P38_sm_qq_zbbx(); 
    ...
    virtual string name() const {return "qq_zbbx (sm)";}

    virtual int code() const {return 10838;}
  ...
  private:
    ...
    double matrix_8_uux_zbbx(); 
    double matrix_8_ddx_zbbx(); 
...
#endif  // PY8MEs_R8_P38_sm_qq_zbbx_H
