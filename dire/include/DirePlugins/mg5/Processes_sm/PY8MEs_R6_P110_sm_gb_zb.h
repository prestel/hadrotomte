...
#ifndef PY8MEs_R6_P110_sm_gb_zb_H
#define PY8MEs_R6_P110_sm_gb_zb_H
...
class PY8MEs_R6_P110_sm_gb_zb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P110_sm_gb_zb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R6_P110_sm_gb_zb(); 
    ...
    virtual string name() const {return "gb_zb (sm)";}

    virtual int code() const {return 10710;}
  ...
  private:
    ...
    double matrix_6_gb_zb(); 
    double matrix_6_gbx_zbx(); 
...
#endif  // PY8MEs_R6_P110_sm_gb_zb_H
