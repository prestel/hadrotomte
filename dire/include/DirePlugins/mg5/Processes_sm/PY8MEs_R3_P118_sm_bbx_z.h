...
#ifndef PY8MEs_R3_P118_sm_bbx_z_H
#define PY8MEs_R3_P118_sm_bbx_z_H
...
class PY8MEs_R3_P118_sm_bbx_z : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R3_P118_sm_bbx_z(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R3_P118_sm_bbx_z(); 
    ...
    virtual string name() const {return "bbx_z (sm)";}

    virtual int code() const {return 10418;}
...
#endif  // PY8MEs_R3_P118_sm_bbx_z_H
