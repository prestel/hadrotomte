...
#ifndef PY8MEs_R5_P42_sm_qq_abbx_H
#define PY8MEs_R5_P42_sm_qq_abbx_H
...
class PY8MEs_R5_P42_sm_qq_abbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P42_sm_qq_abbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P42_sm_qq_abbx(); 
    ...
    virtual string name() const {return "qq_abbx (sm)";}

    virtual int code() const {return 10542;}
  ...
  private:
    ...
    static const int namplitudes = 22; 
    Complex<double> amp[namplitudes]; 
    double matrix_5_uux_abbx(); 
    double matrix_5_ddx_abbx(); 
...
#endif  // PY8MEs_R5_P42_sm_qq_abbx_H
