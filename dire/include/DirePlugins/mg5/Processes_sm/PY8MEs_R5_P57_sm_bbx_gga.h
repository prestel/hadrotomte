...
#ifndef PY8MEs_R5_P57_sm_bbx_gga_H
#define PY8MEs_R5_P57_sm_bbx_gga_H
...
class PY8MEs_R5_P57_sm_bbx_gga : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P57_sm_bbx_gga(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P57_sm_bbx_gga(); 
    ...
    virtual string name() const {return "bbx_gga (sm)";}

    virtual int code() const {return 10557;}
...
#endif  // PY8MEs_R5_P57_sm_bbx_gga_H
