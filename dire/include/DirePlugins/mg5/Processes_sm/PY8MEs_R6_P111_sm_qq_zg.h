...
#ifndef PY8MEs_R6_P111_sm_qq_zg_H
#define PY8MEs_R6_P111_sm_qq_zg_H
...
class PY8MEs_R6_P111_sm_qq_zg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P111_sm_qq_zg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R6_P111_sm_qq_zg(); 
    ...
    virtual int code() const {return 10711;}
  ...
  private:
    ...
    double matrix_6_uux_zg(); 
    double matrix_6_ddx_zg(); 
...
#endif  // PY8MEs_R6_P111_sm_qq_zg_H
