...
#ifndef PY8MEs_R2_P103_sm_gb_ab_H
#define PY8MEs_R2_P103_sm_gb_ab_H
...
class PY8MEs_R2_P103_sm_gb_ab : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P103_sm_gb_ab(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P103_sm_gb_ab(); 
    ...
    virtual string name() const {return "gb_ab (sm)";}

    virtual int code() const {return 10303;}
  ...
  private:
    ...
    double matrix_2_gb_ab(); 
    double matrix_2_gbx_abx(); 
...
#endif  // PY8MEs_R2_P103_sm_gb_ab_H
