...
#include "PY8MEs_R5_P13_sm_gg_ggg.h"
...
// Process: g g > g g g WEIGHTED<=99 @5

// Exception class
class PY8MEs_R5_P13_sm_gg_gggException : public exception
{
  virtual const char * what() const throw()
  {
    return "Exception in class 'PY8MEs_R5_P13_sm_gg_ggg'."; 
  }
}
PY8MEs_R5_P13_sm_gg_ggg_exception; 

std::set<int> PY8MEs_R5_P13_sm_gg_ggg::s_channel_proc = std::set<int>
    (createset<int> ());

int PY8MEs_R5_P13_sm_gg_ggg::helicities[ncomb][nexternal] = {{-1, -1, -1, -1,
...
int PY8MEs_R5_P13_sm_gg_ggg::denom_colors[nprocesses] = {64}; 
int PY8MEs_R5_P13_sm_gg_ggg::denom_hels[nprocesses] = {4}; 
int PY8MEs_R5_P13_sm_gg_ggg::denom_iden[nprocesses] = {6}; 

//--------------------------------------------------------------------------
// Color config initialization
void PY8MEs_R5_P13_sm_gg_ggg::initColorConfigs() 
{
  color_configs = vector < vec_vec_int > (); 
  jamp_nc_relative_power = vector < vec_int > (); 

  // Color flows of process Process: g g > g g g WEIGHTED<=99 @5
...
//--------------------------------------------------------------------------
// Destructor.
PY8MEs_R5_P13_sm_gg_ggg::~PY8MEs_R5_P13_sm_gg_ggg() 
{
...
vector<int> PY8MEs_R5_P13_sm_gg_ggg::invert_mapping(vector<int> mapping) 
{
...
vector < vec_int > PY8MEs_R5_P13_sm_gg_ggg::getHelicityConfigs(vector<int>
    permutation)
{
...
vector < vec_int > PY8MEs_R5_P13_sm_gg_ggg::getColorConfigs(int
...
int PY8MEs_R5_P13_sm_gg_ggg::getColorFlowRelativeNCPower(int color_flow_ID, int
    specify_proc_ID)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
...
vector<int> PY8MEs_R5_P13_sm_gg_ggg::getHelicityConfigForID(int hel_ID,
    vector<int> permutation)
{
  if (hel_ID < 0 || hel_ID >= ncomb)
  {
    cerr <<  "Error in function 'getHelicityConfigForID' of class" << 
    " 'PY8MEs_R5_P13_sm_gg_ggg': Specified helicity ID '" << 
    hel_ID <<  "' cannot be found." << endl; 
    throw PY8MEs_R5_P13_sm_gg_ggg_exception; 
  }
  vector<int> chosenPerm; 
  if (permutation.size() == 0)
  {
...
int PY8MEs_R5_P13_sm_gg_ggg::getHelicityIDForConfig(vector<int> hel_config,
    vector<int> permutation)
{
  vector<int> chosenPerm; 
  if (permutation.size() == 0)
  ...
  if (hel_config.size() > 0)
  {
    ...
    if (user_ihel == -1)
    {
      ...
      " 'PY8MEs_R5_P13_sm_gg_ggg': Specified helicity" << 
...
vector<int> PY8MEs_R5_P13_sm_gg_ggg::getColorConfigForID(int color_ID, int
    specify_proc_ID, vector<int> permutation)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
  ...
  if (color_ID < 0 || color_ID >= int(color_configs[chosenProcID].size()))
  {
    ...
    " 'PY8MEs_R5_P13_sm_gg_ggg': Specified color ID '" << 
...
int PY8MEs_R5_P13_sm_gg_ggg::getColorIDForConfig(vector<int> color_config, int
    specify_proc_ID, vector<int> permutation)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
  ...
  if (color_config.size() > 0)
  {
      ...
      for (unsigned int j = 0; j < (nexternal * 2); j++ )
      {
        ...
        else
        {
          ...
          if (color_linked_pos == -1)
          {
            ...
            " 'PY8MEs_R5_P13_sm_gg_ggg': A color line could " << 
            " not be closed." << endl; 
            throw PY8MEs_R5_P13_sm_gg_ggg_exception; 
          }
    ...
    {
      cerr <<  "Error in function 'getColorIDForConfig' of class" << 
      " 'PY8MEs_R5_P13_sm_gg_ggg': Specified color" << 
      " configuration cannot be found." << endl; 
      throw PY8MEs_R5_P13_sm_gg_ggg_exception; 
    }
  }
...
vector < vec_double > PY8MEs_R5_P13_sm_gg_ggg::getAllResults(int
    specify_proc_ID)
{
  int chosenProcID = -1; 
  if (specify_proc_ID == -1)
...
double PY8MEs_R5_P13_sm_gg_ggg::getResult(int helicity_ID, int color_ID, int
    specify_proc_ID)
{
...
pair < vector<int> , int > PY8MEs_R5_P13_sm_gg_ggg::static_getPY8ME(vector<int>
...
//--------------------------------------------------------------------------
// Set momenta
void PY8MEs_R5_P13_sm_gg_ggg::setMomenta(vector < vec_double > momenta_picked)
{
  if (momenta_picked.size() != nexternal)
  {
    cerr <<  "Error in function 'setMomenta' of class" << 
    " 'PY8MEs_R5_P13_sm_gg_ggg': Incorrect number of" << 
  ...
  for(unsigned int i = 0; i < nexternal; i++ )
  {
    ...
    {
      cerr <<  "Error in function 'setMomenta' of class" << 
      " 'PY8MEs_R5_P13_sm_gg_ggg': A momentum was specified" << 
...
void PY8MEs_R5_P13_sm_gg_ggg::setColors(vector<int> colors_picked)
{
  ...
  if (colors_picked.size() != (2 * nexternal))
  {
    ...
    " 'PY8MEs_R5_P13_sm_gg_ggg': Incorrect number" << 
...
void PY8MEs_R5_P13_sm_gg_ggg::setHelicities(vector<int> helicities_picked) 
{
...
void PY8MEs_R5_P13_sm_gg_ggg::setPermutation(vector<int> perm_picked) 
{
...
void PY8MEs_R5_P13_sm_gg_ggg::setProcID(int procID_picked) 
{
...
void PY8MEs_R5_P13_sm_gg_ggg::initProc() 
{
...
// parameters
void PY8MEs_R5_P13_sm_gg_ggg::syncProcModelParams() 
{
...
void PY8MEs_R5_P13_sm_gg_ggg::setMasses(vec_double external_masses) 
{
...
vector<double> PY8MEs_R5_P13_sm_gg_ggg::getMasses() 
{
...
void PY8MEs_R5_P13_sm_gg_ggg::setExternalMassesMode(int mode) 
{
  if (mode != 0 && mode != 1 && mode != 2)
  {
    cerr <<  "Error in function 'setExternalMassesMode' of class" << 
    " 'PY8MEs_R5_P13_sm_gg_ggg': Incorrect mode selected :" << mode << 
...
double PY8MEs_R5_P13_sm_gg_ggg::sigmaKin() 
{
...
void PY8MEs_R5_P13_sm_gg_ggg::calculate_wavefunctions(const int hel[])
{
...
double PY8MEs_R5_P13_sm_gg_ggg::matrix_5_gg_ggg() 
{
  int i, j; 
  // Local variables
