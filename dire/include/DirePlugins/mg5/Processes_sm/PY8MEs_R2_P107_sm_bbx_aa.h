...
#ifndef PY8MEs_R2_P107_sm_bbx_aa_H
#define PY8MEs_R2_P107_sm_bbx_aa_H
...
class PY8MEs_R2_P107_sm_bbx_aa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P107_sm_bbx_aa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P107_sm_bbx_aa(); 
    ...
    virtual string name() const {return "bbx_aa (sm)";}

    virtual int code() const {return 10307;}
...
#endif  // PY8MEs_R2_P107_sm_bbx_aa_H
