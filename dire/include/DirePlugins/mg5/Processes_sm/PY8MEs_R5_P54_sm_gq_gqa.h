...
#ifndef PY8MEs_R5_P54_sm_gq_gqa_H
#define PY8MEs_R5_P54_sm_gq_gqa_H
...
class PY8MEs_R5_P54_sm_gq_gqa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P54_sm_gq_gqa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P54_sm_gq_gqa(); 
    ...
    virtual string name() const {return "gq_gqa (sm)";}

    virtual int code() const {return 10554;}
  ...
  private:
    ...
    double matrix_5_gu_gua(); 
    double matrix_5_gd_gda(); 
    double matrix_5_gux_guxa(); 
    double matrix_5_gdx_gdxa(); 
...
#endif  // PY8MEs_R5_P54_sm_gq_gqa_H
