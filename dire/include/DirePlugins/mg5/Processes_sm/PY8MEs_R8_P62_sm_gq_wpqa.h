...
#ifndef PY8MEs_R8_P62_sm_gq_wpqa_H
#define PY8MEs_R8_P62_sm_gq_wpqa_H
...
class PY8MEs_R8_P62_sm_gq_wpqa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P62_sm_gq_wpqa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P62_sm_gq_wpqa(); 
    ...
    virtual string name() const {return "gq_wpqa (sm)";}

    virtual int code() const {return 10862;}
  ...
  private:
    ...
    static const int namplitudes = 30; 
    Complex<double> amp[namplitudes]; 
    double matrix_8_gu_wpda(); 
    double matrix_8_gd_wmua(); 
    double matrix_8_gux_wmdxa(); 
    double matrix_8_gdx_wpuxa(); 
...
#endif  // PY8MEs_R8_P62_sm_gq_wpqa_H
