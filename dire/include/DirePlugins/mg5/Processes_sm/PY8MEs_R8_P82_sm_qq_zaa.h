...
#ifndef PY8MEs_R8_P82_sm_qq_zaa_H
#define PY8MEs_R8_P82_sm_qq_zaa_H
...
class PY8MEs_R8_P82_sm_qq_zaa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P82_sm_qq_zaa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P82_sm_qq_zaa(); 
    ...
    virtual string name() const {return "qq_zaa (sm)";}

    virtual int code() const {return 10882;}
  ...
  private:
    ...
    double matrix_8_uux_zaa(); 
    double matrix_8_ddx_zaa(); 
...
#endif  // PY8MEs_R8_P82_sm_qq_zaa_H
