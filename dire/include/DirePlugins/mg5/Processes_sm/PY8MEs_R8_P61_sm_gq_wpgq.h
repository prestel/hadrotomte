...
#ifndef PY8MEs_R8_P61_sm_gq_wpgq_H
#define PY8MEs_R8_P61_sm_gq_wpgq_H
...
class PY8MEs_R8_P61_sm_gq_wpgq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P61_sm_gq_wpgq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P61_sm_gq_wpgq(); 
    ...
    virtual string name() const {return "gq_wpgq (sm)";}

    virtual int code() const {return 10861;}
  ...
  private:
    ...
    double matrix_8_gu_wpgd(); 
    double matrix_8_gd_wmgu(); 
    double matrix_8_gux_wmgdx(); 
    double matrix_8_gdx_wpgux(); 
...
#endif  // PY8MEs_R8_P61_sm_gq_wpgq_H
