...
#ifndef PY8MEs_R5_P34_sm_gb_qqb_H
#define PY8MEs_R5_P34_sm_gb_qqb_H
...
class PY8MEs_R5_P34_sm_gb_qqb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P34_sm_gb_qqb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P34_sm_gb_qqb(); 
    ...
    virtual string name() const {return "gb_qqb (sm)";}

    virtual int code() const {return 10534;}
  ...
  private:
    ...
    double matrix_5_gb_uuxb(); 
    double matrix_5_gb_ddxb(); 
    double matrix_5_gbx_uuxbx(); 
    double matrix_5_gbx_ddxbx(); 
...
#endif  // PY8MEs_R5_P34_sm_gb_qqb_H
