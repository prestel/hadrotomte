...
#ifndef PY8MEs_R6_P112_sm_qq_za_H
#define PY8MEs_R6_P112_sm_qq_za_H
...
class PY8MEs_R6_P112_sm_qq_za : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P112_sm_qq_za(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R6_P112_sm_qq_za(); 
    ...
    virtual string name() const {return "qq_za (sm)";}

    virtual int code() const {return 10712;}
  ...
  private:
    ...
    double matrix_6_uux_za(); 
    double matrix_6_ddx_za(); 
...
#endif  // PY8MEs_R6_P112_sm_qq_za_H
