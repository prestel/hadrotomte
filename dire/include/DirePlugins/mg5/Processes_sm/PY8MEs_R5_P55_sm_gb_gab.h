...
#ifndef PY8MEs_R5_P55_sm_gb_gab_H
#define PY8MEs_R5_P55_sm_gb_gab_H
...
class PY8MEs_R5_P55_sm_gb_gab : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P55_sm_gb_gab(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P55_sm_gb_gab(); 
    ...
    virtual string name() const {return "gb_gab (sm)";}

    virtual int code() const {return 10555;}
  ...
  private:
    ...
    double matrix_5_gb_gab(); 
    double matrix_5_gbx_gabx(); 
...
#endif  // PY8MEs_R5_P55_sm_gb_gab_H
