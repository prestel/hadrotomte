...
#ifndef PY8MEs_R7_P28_sm_gg_llbbx_H
#define PY8MEs_R7_P28_sm_gg_llbbx_H
...
class PY8MEs_R7_P28_sm_gg_llbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P28_sm_gg_llbbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P28_sm_gg_llbbx(); 
    ...
    virtual string name() const {return "gg_llbbx (sm)";}

    virtual int code() const {return 10728;}
  ...
  private:
    ...
    double matrix_7_gg_emepbbx(); 
    double matrix_7_gg_vevexbbx(); 
...
#endif  // PY8MEs_R7_P28_sm_gg_llbbx_H
