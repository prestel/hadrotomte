...
#ifndef PY8MEs_R4_P88_sm_qq_llg_H
#define PY8MEs_R4_P88_sm_qq_llg_H
...
class PY8MEs_R4_P88_sm_qq_llg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R4_P88_sm_qq_llg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R4_P88_sm_qq_llg(); 
    ...
    virtual string name() const {return "qq_llg (sm)";}

    virtual int code() const {return 10488;}
  ...
  private:
    ...
    double matrix_4_uux_emepg(); 
    double matrix_4_ddx_emepg(); 
    double matrix_4_uux_vevexg(); 
    double matrix_4_udx_veepg(); 
    double matrix_4_dux_emvexg(); 
    double matrix_4_ddx_vevexg(); 
...
#endif  // PY8MEs_R4_P88_sm_qq_llg_H
