...
#ifndef PY8MEs_R3_P117_sm_qq_wp_H
#define PY8MEs_R3_P117_sm_qq_wp_H
...
class PY8MEs_R3_P117_sm_qq_wp : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R3_P117_sm_qq_wp(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R3_P117_sm_qq_wp(); 
    ...
    virtual string name() const {return "qq_wp (sm)";}

    virtual int code() const {return 10417;}
  ...
  private:
    ...
    double matrix_3_udx_wp(); 
    double matrix_3_dux_wm(); 
...
#endif  // PY8MEs_R3_P117_sm_qq_wp_H
