...
#ifndef PY8MEs_R5_P37_sm_bbx_gqq_H
#define PY8MEs_R5_P37_sm_bbx_gqq_H
...
class PY8MEs_R5_P37_sm_bbx_gqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P37_sm_bbx_gqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P37_sm_bbx_gqq(); 
    ...
    virtual string name() const {return "bbx_gqq (sm)";}

    virtual int code() const {return 10537;}
  ...
  private:
    ...
    static const int namplitudes = 21; 
    Complex<double> amp[namplitudes]; 
    double matrix_5_bbx_guux(); 
    double matrix_5_bbx_gddx(); 
...
#endif  // PY8MEs_R5_P37_sm_bbx_gqq_H
