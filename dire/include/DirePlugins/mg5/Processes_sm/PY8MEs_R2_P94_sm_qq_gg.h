...
#ifndef PY8MEs_R2_P94_sm_qq_gg_H
#define PY8MEs_R2_P94_sm_qq_gg_H
...
class PY8MEs_R2_P94_sm_qq_gg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P94_sm_qq_gg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P94_sm_qq_gg(); 
    ...
    virtual int code() const {return 10294;}
...
#endif  // PY8MEs_R2_P94_sm_qq_gg_H
