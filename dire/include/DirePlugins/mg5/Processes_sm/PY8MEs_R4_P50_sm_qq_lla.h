...
#ifndef PY8MEs_R4_P50_sm_qq_lla_H
#define PY8MEs_R4_P50_sm_qq_lla_H
...
class PY8MEs_R4_P50_sm_qq_lla : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R4_P50_sm_qq_lla(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R4_P50_sm_qq_lla(); 
    ...
    virtual string name() const {return "qq_lla (sm)";}

    virtual int code() const {return 10450;}
  ...
  private:
    ...
    double matrix_4_uux_emepa(); 
    double matrix_4_ddx_emepa(); 
    double matrix_4_udx_veepa(); 
    double matrix_4_dux_emvexa(); 
    double matrix_4_uux_vevexa(); 
    double matrix_4_ddx_vevexa(); 
...
#endif  // PY8MEs_R4_P50_sm_qq_lla_H
