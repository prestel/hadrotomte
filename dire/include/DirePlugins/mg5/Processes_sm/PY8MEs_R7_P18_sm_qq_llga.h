...
#ifndef PY8MEs_R7_P18_sm_qq_llga_H
#define PY8MEs_R7_P18_sm_qq_llga_H
...
class PY8MEs_R7_P18_sm_qq_llga : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P18_sm_qq_llga(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P18_sm_qq_llga(); 
    ...
    virtual string name() const {return "qq_llga (sm)";}

    virtual int code() const {return 10718;}
  ...
  private:
    ...
    static const int namplitudes = 72; 
    Complex<double> amp[namplitudes]; 
    double matrix_7_uux_emepga(); 
    double matrix_7_ddx_emepga(); 
    double matrix_7_udx_veepga(); 
    double matrix_7_dux_emvexga(); 
    double matrix_7_uux_vevexga(); 
    double matrix_7_ddx_vevexga(); 
...
#endif  // PY8MEs_R7_P18_sm_qq_llga_H
