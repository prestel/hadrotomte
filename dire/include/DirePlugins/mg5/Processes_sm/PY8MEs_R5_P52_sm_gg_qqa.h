...
#ifndef PY8MEs_R5_P52_sm_gg_qqa_H
#define PY8MEs_R5_P52_sm_gg_qqa_H
...
class PY8MEs_R5_P52_sm_gg_qqa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P52_sm_gg_qqa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P52_sm_gg_qqa(); 
    ...
    virtual string name() const {return "gg_qqa (sm)";}

    virtual int code() const {return 10552;}
  ...
  private:
    ...
    double matrix_5_gg_uuxa(); 
    double matrix_5_gg_ddxa(); 
...
#endif  // PY8MEs_R5_P52_sm_gg_qqa_H
