...
#ifndef PY8MEs_R7_P3_sm_bbx_llaa_H
#define PY8MEs_R7_P3_sm_bbx_llaa_H
...
class PY8MEs_R7_P3_sm_bbx_llaa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P3_sm_bbx_llaa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P3_sm_bbx_llaa(); 
    ...
    virtual string name() const {return "bbx_llaa (sm)";}

    virtual int code() const {return 10703;}
  ...
  private:
    ...
    static const int namplitudes = 46; 
    Complex<double> amp[namplitudes]; 
    double matrix_7_bbx_emepaa(); 
    double matrix_7_bbx_vevexaa(); 
...
#endif  // PY8MEs_R7_P3_sm_bbx_llaa_H
