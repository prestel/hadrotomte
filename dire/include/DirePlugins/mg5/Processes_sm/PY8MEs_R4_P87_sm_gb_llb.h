...
#ifndef PY8MEs_R4_P87_sm_gb_llb_H
#define PY8MEs_R4_P87_sm_gb_llb_H
...
class PY8MEs_R4_P87_sm_gb_llb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R4_P87_sm_gb_llb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R4_P87_sm_gb_llb(); 
    ...
    virtual string name() const {return "gb_llb (sm)";}

    virtual int code() const {return 10487;}
  ...
  private:
    ...
    double matrix_4_gb_emepb(); 
    double matrix_4_gbx_emepbx(); 
    double matrix_4_gb_vevexb(); 
    double matrix_4_gbx_vevexbx(); 
...
#endif  // PY8MEs_R4_P87_sm_gb_llb_H
