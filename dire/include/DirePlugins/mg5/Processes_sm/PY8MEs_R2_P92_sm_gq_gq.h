...
#ifndef PY8MEs_R2_P92_sm_gq_gq_H
#define PY8MEs_R2_P92_sm_gq_gq_H
...
class PY8MEs_R2_P92_sm_gq_gq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P92_sm_gq_gq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P92_sm_gq_gq(); 
    ...
    virtual string name() const {return "gq_gq (sm)";}

    virtual int code() const {return 10292;}
  ...
  private:
    ...
    double matrix_2_gu_gu(); 
    double matrix_2_gux_gux(); 
...
#endif  // PY8MEs_R2_P92_sm_gq_gq_H
