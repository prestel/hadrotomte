...
#ifndef PY8MEs_R5_P56_sm_qq_gga_H
#define PY8MEs_R5_P56_sm_qq_gga_H
...
class PY8MEs_R5_P56_sm_qq_gga : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P56_sm_qq_gga(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P56_sm_qq_gga(); 
    ...
    virtual string name() const {return "qq_gga (sm)";}

    virtual int code() const {return 10556;}
  ...
  private:
    ...
    double matrix_5_uux_gga(); 
    double matrix_5_ddx_gga(); 
...
#endif  // PY8MEs_R5_P56_sm_qq_gga_H
