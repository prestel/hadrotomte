...
#ifndef PY8MEs_R4_P51_sm_bbx_lla_H
#define PY8MEs_R4_P51_sm_bbx_lla_H
...
class PY8MEs_R4_P51_sm_bbx_lla : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R4_P51_sm_bbx_lla(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R4_P51_sm_bbx_lla(); 
    ...
    virtual string name() const {return "bbx_lla (sm)";}

    virtual int code() const {return 10451;}
  ...
  private:
    ...
    double matrix_4_bbx_emepa(); 
    double matrix_4_bbx_vevexa(); 
...
#endif  // PY8MEs_R4_P51_sm_bbx_lla_H
