...
#ifndef PY8MEs_R6_P113_sm_qq_wpg_H
#define PY8MEs_R6_P113_sm_qq_wpg_H
...
class PY8MEs_R6_P113_sm_qq_wpg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P113_sm_qq_wpg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R6_P113_sm_qq_wpg(); 
    ...
    virtual string name() const {return "qq_wpg (sm)";}

    virtual int code() const {return 10713;}
  ...
  private:
    ...
    double matrix_6_udx_wpg(); 
    double matrix_6_dux_wmg(); 
...
#endif  // PY8MEs_R6_P113_sm_qq_wpg_H
