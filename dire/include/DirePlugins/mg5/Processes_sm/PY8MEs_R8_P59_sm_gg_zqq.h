...
#ifndef PY8MEs_R8_P59_sm_gg_zqq_H
#define PY8MEs_R8_P59_sm_gg_zqq_H
...
class PY8MEs_R8_P59_sm_gg_zqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P59_sm_gg_zqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P59_sm_gg_zqq(); 
    ...
    virtual string name() const {return "gg_zqq (sm)";}

    virtual int code() const {return 10859;}
  ...
  private:
    ...
    double matrix_8_gg_zuux(); 
    double matrix_8_gg_zddx(); 
...
#endif  // PY8MEs_R8_P59_sm_gg_zqq_H
