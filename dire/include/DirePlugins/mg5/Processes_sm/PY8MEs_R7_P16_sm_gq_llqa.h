...
#ifndef PY8MEs_R7_P16_sm_gq_llqa_H
#define PY8MEs_R7_P16_sm_gq_llqa_H
...
class PY8MEs_R7_P16_sm_gq_llqa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P16_sm_gq_llqa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P16_sm_gq_llqa(); 
    ...
    virtual string name() const {return "gq_llqa (sm)";}

    virtual int code() const {return 10716;}
  ...
  private:
    ...
    static const int namplitudes = 144; 
    Complex<double> amp[namplitudes]; 
    double matrix_7_gu_emepua(); 
    double matrix_7_gd_emepda(); 
    double matrix_7_gux_emepuxa(); 
    double matrix_7_gdx_emepdxa(); 
    double matrix_7_gu_veepda(); 
    double matrix_7_gd_emvexua(); 
    double matrix_7_gux_emvexdxa(); 
    double matrix_7_gdx_veepuxa(); 
    double matrix_7_gu_vevexua(); 
    double matrix_7_gd_vevexda(); 
    double matrix_7_gux_vevexuxa(); 
    double matrix_7_gdx_vevexdxa(); 

    // Constants for array limits
    static const int nexternal = 6; 
    static const int ninitial = 2; 
    static const int nprocesses = 12; 
...
#endif  // PY8MEs_R7_P16_sm_gq_llqa_H
