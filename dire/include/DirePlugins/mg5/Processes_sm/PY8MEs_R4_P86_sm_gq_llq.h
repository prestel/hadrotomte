...
#ifndef PY8MEs_R4_P86_sm_gq_llq_H
#define PY8MEs_R4_P86_sm_gq_llq_H
...
class PY8MEs_R4_P86_sm_gq_llq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R4_P86_sm_gq_llq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R4_P86_sm_gq_llq(); 
    ...
    virtual string name() const {return "gq_llq (sm)";}

    virtual int code() const {return 10486;}
  ...
  private:
    ...
    double matrix_4_gu_emepu(); 
    double matrix_4_gd_emepd(); 
    double matrix_4_gux_emepux(); 
    double matrix_4_gdx_emepdx(); 
    double matrix_4_gu_veepd(); 
    double matrix_4_gu_vevexu(); 
    double matrix_4_gd_emvexu(); 
    double matrix_4_gd_vevexd(); 
    double matrix_4_gux_emvexdx(); 
    double matrix_4_gux_vevexux(); 
    double matrix_4_gdx_veepux(); 
    double matrix_4_gdx_vevexdx(); 
...
#endif  // PY8MEs_R4_P86_sm_gq_llq_H
