...
#ifndef PY8MEs_R1_P101_sm_bbx_ll_H
#define PY8MEs_R1_P101_sm_bbx_ll_H
...
class PY8MEs_R1_P101_sm_bbx_ll : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R1_P101_sm_bbx_ll(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R1_P101_sm_bbx_ll(); 
    ...
    virtual string name() const {return "bbx_ll (sm)";}
  ...
  private:
    ...
    double matrix_1_bbx_emep(); 
    double matrix_1_bbx_vevex(); 
...
#endif  // PY8MEs_R1_P101_sm_bbx_ll_H
