...
#ifndef PY8MEs_R5_P33_sm_gq_qbbx_H
#define PY8MEs_R5_P33_sm_gq_qbbx_H
...
class PY8MEs_R5_P33_sm_gq_qbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P33_sm_gq_qbbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P33_sm_gq_qbbx(); 
    ...
    virtual string name() const {return "gq_qbbx (sm)";}

    virtual int code() const {return 10533;}
  ...
  private:
    ...
    static const int namplitudes = 47; 
    Complex<double> amp[namplitudes]; 
    double matrix_5_gu_ubbx(); 
    double matrix_5_gd_dbbx(); 
    double matrix_5_gux_uxbbx(); 
    double matrix_5_gdx_dxbbx(); 
...
#endif  // PY8MEs_R5_P33_sm_gq_qbbx_H
