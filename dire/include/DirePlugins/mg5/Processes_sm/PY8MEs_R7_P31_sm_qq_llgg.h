...
#ifndef PY8MEs_R7_P31_sm_qq_llgg_H
#define PY8MEs_R7_P31_sm_qq_llgg_H
...
class PY8MEs_R7_P31_sm_qq_llgg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P31_sm_qq_llgg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P31_sm_qq_llgg(); 
    ...
    virtual string name() const {return "qq_llgg (sm)";}

    virtual int code() const {return 10731;}
  ...
  private:
    ...
    static const int nwavefuncs = 21; 
    Complex<double> w[nwavefuncs][18]; 
    static const int namplitudes = 64; 
    Complex<double> amp[namplitudes]; 
    double matrix_7_uux_emepgg(); 
    double matrix_7_ddx_emepgg(); 
    double matrix_7_uux_vevexgg(); 
    double matrix_7_udx_veepgg(); 
    double matrix_7_dux_emvexgg(); 
    double matrix_7_ddx_vevexgg(); 
...
#endif  // PY8MEs_R7_P31_sm_qq_llgg_H
