...
#ifndef PY8MEs_R8_P71_sm_bbx_wplvl_H
#define PY8MEs_R8_P71_sm_bbx_wplvl_H
...
class PY8MEs_R8_P71_sm_bbx_wplvl : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P71_sm_bbx_wplvl(Parameters_sm * model) : pars(model) 
    {
      initProc(); 
    }

    // Destructor.
    ~PY8MEs_R8_P71_sm_bbx_wplvl(); 
    ...
    virtual string name() const {return "bbx_wplvl (sm)";}

    virtual int code() const {return 10871;}
  ...
  private:
    ...
    double matrix_8_bbx_wpemvex(); 
    double matrix_8_bbx_wmveep(); 
...
#endif  // PY8MEs_R8_P71_sm_bbx_wplvl_H
