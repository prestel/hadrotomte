...
#ifndef PY8MEs_R2_P106_sm_bbx_ga_H
#define PY8MEs_R2_P106_sm_bbx_ga_H
...
class PY8MEs_R2_P106_sm_bbx_ga : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P106_sm_bbx_ga(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P106_sm_bbx_ga(); 
    ...
    virtual string name() const {return "bbx_ga (sm)";}

    virtual int code() const {return 10306;}
...
#endif  // PY8MEs_R2_P106_sm_bbx_ga_H
