...
#ifndef PY8MEs_R8_P60_sm_gg_zbbx_H
#define PY8MEs_R8_P60_sm_gg_zbbx_H
...
class PY8MEs_R8_P60_sm_gg_zbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P60_sm_gg_zbbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P60_sm_gg_zbbx(); 
    ...
    virtual string name() const {return "gg_zbbx (sm)";}

    virtual int code() const {return 10860;}
...
#endif  // PY8MEs_R8_P60_sm_gg_zbbx_H
