...
#ifndef PY8MEs_R5_P6_sm_bb_gbb_H
#define PY8MEs_R5_P6_sm_bb_gbb_H
...
class PY8MEs_R5_P6_sm_bb_gbb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P6_sm_bb_gbb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P6_sm_bb_gbb(); 
    ...
    virtual string name() const {return "bb_gbb (sm)";}

    virtual int code() const {return 10506;}
  ...
  private:
    ...
    double matrix_5_bb_gbb(); 
    double matrix_5_bbx_gbbx(); 
    double matrix_5_bxbx_gbxbx(); 
...
#endif  // PY8MEs_R5_P6_sm_bb_gbb_H
