...
#ifndef PY8MEs_R8_P63_sm_gq_zgq_H
#define PY8MEs_R8_P63_sm_gq_zgq_H
...
class PY8MEs_R8_P63_sm_gq_zgq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P63_sm_gq_zgq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P63_sm_gq_zgq(); 
    ...
    virtual string name() const {return "gq_zgq (sm)";}

    virtual int code() const {return 10863;}
  ...
  private:
    ...
    double matrix_8_gu_zgu(); 
    double matrix_8_gd_zgd(); 
    double matrix_8_gux_zgux(); 
    double matrix_8_gdx_zgdx(); 
...
#endif  // PY8MEs_R8_P63_sm_gq_zgq_H
