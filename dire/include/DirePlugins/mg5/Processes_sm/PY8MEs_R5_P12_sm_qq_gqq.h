...
#ifndef PY8MEs_R5_P12_sm_qq_gqq_H
#define PY8MEs_R5_P12_sm_qq_gqq_H
...
class PY8MEs_R5_P12_sm_qq_gqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P12_sm_qq_gqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P12_sm_qq_gqq(); 
    ...
    virtual int code() const {return 10512;}
  ...
  private:
    ...
    static const int namplitudes = 450; 
    Complex<double> amp[namplitudes]; 
    double matrix_5_uu_guu(); 
    double matrix_5_uux_guux(); 
    double matrix_5_dd_gdd(); 
    double matrix_5_ddx_gddx(); 
    double matrix_5_uxux_guxux(); 
    double matrix_5_dxdx_gdxdx(); 
    double matrix_5_ud_gud(); 
    double matrix_5_uux_gddx(); 
    double matrix_5_udx_gudx(); 
    double matrix_5_dux_gdux(); 
    double matrix_5_ddx_guux(); 
    double matrix_5_uxdx_guxdx(); 
    double matrix_5_uc_guc(); 
    double matrix_5_us_gus(); 
    double matrix_5_uux_gccx(); 
    double matrix_5_uux_gssx(); 
    double matrix_5_ucx_gucx(); 
    double matrix_5_usx_gusx(); 
    double matrix_5_ds_gds(); 
    double matrix_5_dcx_gdcx(); 
    double matrix_5_ddx_gccx(); 
    double matrix_5_ddx_gssx(); 
    double matrix_5_dsx_gdsx(); 
    double matrix_5_uxcx_guxcx(); 
    double matrix_5_uxsx_guxsx(); 
    double matrix_5_dxsx_gdxsx(); 
    double matrix_5_us_gcd(); 
    double matrix_5_ucx_gdsx(); 
    double matrix_5_udx_gcsx(); 
    double matrix_5_dux_gscx(); 
    double matrix_5_uxsx_gcxdx(); 
...
#endif  // PY8MEs_R5_P12_sm_qq_gqq_H
