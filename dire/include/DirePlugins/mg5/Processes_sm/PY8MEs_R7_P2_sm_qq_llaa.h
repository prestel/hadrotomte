...
#ifndef PY8MEs_R7_P2_sm_qq_llaa_H
#define PY8MEs_R7_P2_sm_qq_llaa_H
...
class PY8MEs_R7_P2_sm_qq_llaa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P2_sm_qq_llaa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P2_sm_qq_llaa(); 
    ...
    virtual string name() const {return "qq_llaa (sm)";}

    virtual int code() const {return 10702;}
  ...
  private:
    ...
    static const int nwavefuncs = 74; 
    Complex<double> w[nwavefuncs][18]; 
    static const int namplitudes = 134; 
    Complex<double> amp[namplitudes]; 
    double matrix_7_uux_emepaa(); 
    double matrix_7_ddx_emepaa(); 
    double matrix_7_udx_veepaa(); 
    double matrix_7_dux_emvexaa(); 
    double matrix_7_uux_vevexaa(); 
    double matrix_7_ddx_vevexaa(); 
...
#endif  // PY8MEs_R7_P2_sm_qq_llaa_H
