...
#ifndef PY8MEs_R7_P7_sm_qq_llbbx_H
#define PY8MEs_R7_P7_sm_qq_llbbx_H
...
class PY8MEs_R7_P7_sm_qq_llbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P7_sm_qq_llbbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P7_sm_qq_llbbx(); 
    ...
    virtual string name() const {return "qq_llbbx (sm)";}
  ...
  private:
    ...
    double matrix_7_uux_emepbbx(); 
    double matrix_7_ddx_emepbbx(); 
    double matrix_7_uux_vevexbbx(); 
    double matrix_7_ddx_vevexbbx(); 
    double matrix_7_udx_veepbbx(); 
    double matrix_7_dux_emvexbbx(); 
...
#endif  // PY8MEs_R7_P7_sm_qq_llbbx_H
