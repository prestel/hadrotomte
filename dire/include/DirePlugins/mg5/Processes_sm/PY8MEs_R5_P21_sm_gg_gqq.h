...
#ifndef PY8MEs_R5_P21_sm_gg_gqq_H
#define PY8MEs_R5_P21_sm_gg_gqq_H
...
class PY8MEs_R5_P21_sm_gg_gqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P21_sm_gg_gqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P21_sm_gg_gqq(); 
    ...
    virtual int code() const {return 10521;}
...
#endif  // PY8MEs_R5_P21_sm_gg_gqq_H
