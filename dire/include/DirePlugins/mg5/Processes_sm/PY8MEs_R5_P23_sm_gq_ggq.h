...
#ifndef PY8MEs_R5_P23_sm_gq_ggq_H
#define PY8MEs_R5_P23_sm_gq_ggq_H
...
class PY8MEs_R5_P23_sm_gq_ggq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P23_sm_gq_ggq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P23_sm_gq_ggq(); 
    ...
    virtual int code() const {return 10523;}
  ...
  private:
    ...
    double matrix_5_gu_ggu(); 
    double matrix_5_gux_ggux(); 
...
#endif  // PY8MEs_R5_P23_sm_gq_ggq_H
