...
#ifndef PY8MEs_R5_P74_sm_gb_aab_H
#define PY8MEs_R5_P74_sm_gb_aab_H
...
class PY8MEs_R5_P74_sm_gb_aab : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P74_sm_gb_aab(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P74_sm_gb_aab(); 
    ...
    virtual string name() const {return "gb_aab (sm)";}

    virtual int code() const {return 10574;}
  ...
  private:
    ...
    double matrix_5_gb_aab(); 
    double matrix_5_gbx_aabx(); 
...
#endif  // PY8MEs_R5_P74_sm_gb_aab_H
