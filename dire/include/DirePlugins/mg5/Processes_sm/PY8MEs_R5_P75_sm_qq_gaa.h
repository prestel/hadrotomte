...
#ifndef PY8MEs_R5_P75_sm_qq_gaa_H
#define PY8MEs_R5_P75_sm_qq_gaa_H
...
class PY8MEs_R5_P75_sm_qq_gaa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P75_sm_qq_gaa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P75_sm_qq_gaa(); 
    ...
    virtual string name() const {return "qq_gaa (sm)";}

    virtual int code() const {return 10575;}
  ...
  private:
    ...
    double matrix_5_uux_gaa(); 
    double matrix_5_ddx_gaa(); 
...
#endif  // PY8MEs_R5_P75_sm_qq_gaa_H
