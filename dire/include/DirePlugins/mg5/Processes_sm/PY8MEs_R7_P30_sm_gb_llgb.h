...
#ifndef PY8MEs_R7_P30_sm_gb_llgb_H
#define PY8MEs_R7_P30_sm_gb_llgb_H
...
class PY8MEs_R7_P30_sm_gb_llgb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P30_sm_gb_llgb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P30_sm_gb_llgb(); 
    ...
    virtual string name() const {return "gb_llgb (sm)";}

    virtual int code() const {return 10730;}
  ...
  private:
    ...
    double matrix_7_gb_emepgb(); 
    double matrix_7_gbx_emepgbx(); 
    double matrix_7_gb_vevexgb(); 
    double matrix_7_gbx_vevexgbx(); 
...
#endif  // PY8MEs_R7_P30_sm_gb_llgb_H
