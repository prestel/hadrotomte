...
#ifndef PY8MEs_R7_P9_sm_bbx_llqq_H
#define PY8MEs_R7_P9_sm_bbx_llqq_H
...
class PY8MEs_R7_P9_sm_bbx_llqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P9_sm_bbx_llqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P9_sm_bbx_llqq(); 
    ...
    virtual string name() const {return "bbx_llqq (sm)";}

    virtual int code() const {return 10709;}
  ...
  private:
    ...
    static const int namplitudes = 118; 
    Complex<double> amp[namplitudes]; 
    double matrix_7_bbx_emepuux(); 
    double matrix_7_bbx_emepddx(); 
    double matrix_7_bbx_vevexuux(); 
    double matrix_7_bbx_vevexddx(); 
    double matrix_7_bbx_emvexudx(); 
    double matrix_7_bbx_veepdux(); 
...
#endif  // PY8MEs_R7_P9_sm_bbx_llqq_H
