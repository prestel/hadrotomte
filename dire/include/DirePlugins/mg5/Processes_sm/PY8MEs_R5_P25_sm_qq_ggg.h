...
#ifndef PY8MEs_R5_P25_sm_qq_ggg_H
#define PY8MEs_R5_P25_sm_qq_ggg_H
...
class PY8MEs_R5_P25_sm_qq_ggg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P25_sm_qq_ggg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P25_sm_qq_ggg(); 
    ...
    virtual int code() const {return 10525;}
...
#endif  // PY8MEs_R5_P25_sm_qq_ggg_H
