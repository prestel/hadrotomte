...
#ifndef PY8MEs_R5_P26_sm_bbx_ggg_H
#define PY8MEs_R5_P26_sm_bbx_ggg_H
...
class PY8MEs_R5_P26_sm_bbx_ggg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P26_sm_bbx_ggg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P26_sm_bbx_ggg(); 
    ...
    virtual string name() const {return "bbx_ggg (sm)";}

    virtual int code() const {return 10526;}
...
#endif  // PY8MEs_R5_P26_sm_bbx_ggg_H
