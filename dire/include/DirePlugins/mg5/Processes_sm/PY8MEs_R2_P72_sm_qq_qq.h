...
#ifndef PY8MEs_R2_P72_sm_qq_qq_H
#define PY8MEs_R2_P72_sm_qq_qq_H
...
class PY8MEs_R2_P72_sm_qq_qq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P72_sm_qq_qq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P72_sm_qq_qq(); 
    ...
    virtual string name() const {return "qq_qq (sm)";}

    virtual int code() const {return 10272;}
  ...
  private:
    ...
    static const int namplitudes = 99; 
    Complex<double> amp[namplitudes]; 
    double matrix_2_uu_uu(); 
    double matrix_2_uux_uux(); 
    double matrix_2_dd_dd(); 
    double matrix_2_ddx_ddx(); 
    double matrix_2_uxux_uxux(); 
    double matrix_2_dxdx_dxdx(); 
    double matrix_2_ud_ud(); 
    double matrix_2_uux_ddx(); 
    double matrix_2_udx_udx(); 
    double matrix_2_dux_dux(); 
    double matrix_2_ddx_uux(); 
    double matrix_2_uxdx_uxdx(); 
    double matrix_2_uc_uc(); 
    double matrix_2_us_us(); 
    double matrix_2_uux_ccx(); 
    double matrix_2_uux_ssx(); 
    double matrix_2_ucx_ucx(); 
    double matrix_2_usx_usx(); 
    double matrix_2_ds_ds(); 
    double matrix_2_dcx_dcx(); 
    double matrix_2_ddx_ccx(); 
    double matrix_2_ddx_ssx(); 
    double matrix_2_dsx_dsx(); 
    double matrix_2_uxcx_uxcx(); 
    double matrix_2_uxsx_uxsx(); 
    double matrix_2_dxsx_dxsx(); 
    double matrix_2_us_cd(); 
    double matrix_2_ucx_dsx(); 
    double matrix_2_udx_csx(); 
    double matrix_2_dux_scx(); 
    double matrix_2_uxsx_cxdx(); 

    // Constants for array limits
    static const int nexternal = 4; 
    static const int ninitial = 2; 
    static const int nprocesses = 31; 
...
#endif  // PY8MEs_R2_P72_sm_qq_qq_H
