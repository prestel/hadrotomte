...
#ifndef PY8MEs_R8_P64_sm_gb_zgb_H
#define PY8MEs_R8_P64_sm_gb_zgb_H
...
class PY8MEs_R8_P64_sm_gb_zgb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P64_sm_gb_zgb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P64_sm_gb_zgb(); 
    ...
    virtual string name() const {return "gb_zgb (sm)";}

    virtual int code() const {return 10864;}
  ...
  private:
    ...
    double matrix_8_gb_zgb(); 
    double matrix_8_gbx_zgbx(); 
...
#endif  // PY8MEs_R8_P64_sm_gb_zgb_H
