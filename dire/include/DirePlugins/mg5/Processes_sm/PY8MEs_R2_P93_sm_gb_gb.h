...
#ifndef PY8MEs_R2_P93_sm_gb_gb_H
#define PY8MEs_R2_P93_sm_gb_gb_H
...
class PY8MEs_R2_P93_sm_gb_gb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P93_sm_gb_gb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P93_sm_gb_gb(); 
    ...
    virtual string name() const {return "gb_gb (sm)";}

    virtual int code() const {return 10293;}
  ...
  private:
    ...
    double matrix_2_gb_gb(); 
    double matrix_2_gbx_gbx(); 
...
#endif  // PY8MEs_R2_P93_sm_gb_gb_H
