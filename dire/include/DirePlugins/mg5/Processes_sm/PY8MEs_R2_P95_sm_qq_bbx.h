...
#ifndef PY8MEs_R2_P95_sm_qq_bbx_H
#define PY8MEs_R2_P95_sm_qq_bbx_H
...
class PY8MEs_R2_P95_sm_qq_bbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P95_sm_qq_bbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P95_sm_qq_bbx(); 
    ...
    virtual string name() const {return "qq_bbx (sm)";}

    virtual int code() const {return 10295;}
  ...
  private:
    ...
    double matrix_2_uux_bbx(); 
    double matrix_2_ddx_bbx(); 
...
#endif  // PY8MEs_R2_P95_sm_qq_bbx_H
