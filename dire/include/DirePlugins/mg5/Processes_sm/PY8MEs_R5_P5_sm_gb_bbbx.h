...
#ifndef PY8MEs_R5_P5_sm_gb_bbbx_H
#define PY8MEs_R5_P5_sm_gb_bbbx_H
...
class PY8MEs_R5_P5_sm_gb_bbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P5_sm_gb_bbbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P5_sm_gb_bbbx(); 
    ...
    virtual string name() const {return "gb_bbbx (sm)";}

    virtual int code() const {return 10505;}
...
#endif  // PY8MEs_R5_P5_sm_gb_bbbx_H
