...
#ifndef PY8MEs_R4_P89_sm_bbx_llg_H
#define PY8MEs_R4_P89_sm_bbx_llg_H
...
class PY8MEs_R4_P89_sm_bbx_llg : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R4_P89_sm_bbx_llg(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R4_P89_sm_bbx_llg(); 
    ...
    virtual string name() const {return "bbx_llg (sm)";}

    virtual int code() const {return 10489;}
  ...
  private:
    ...
    double matrix_4_bbx_emepg(); 
    double matrix_4_bbx_vevexg(); 
...
#endif  // PY8MEs_R4_P89_sm_bbx_llg_H
