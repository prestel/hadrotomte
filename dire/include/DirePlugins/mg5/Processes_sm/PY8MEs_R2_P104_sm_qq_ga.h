...
#ifndef PY8MEs_R2_P104_sm_qq_ga_H
#define PY8MEs_R2_P104_sm_qq_ga_H
...
class PY8MEs_R2_P104_sm_qq_ga : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P104_sm_qq_ga(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P104_sm_qq_ga(); 
    ...
    virtual string name() const {return "qq_ga (sm)";}

    virtual int code() const {return 10304;}
  ...
  private:
    ...
    double matrix_2_uux_ga(); 
    double matrix_2_ddx_ga(); 
...
#endif  // PY8MEs_R2_P104_sm_qq_ga_H
