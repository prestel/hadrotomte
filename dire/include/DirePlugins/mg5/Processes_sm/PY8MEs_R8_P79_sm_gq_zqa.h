...
#ifndef PY8MEs_R8_P79_sm_gq_zqa_H
#define PY8MEs_R8_P79_sm_gq_zqa_H
...
class PY8MEs_R8_P79_sm_gq_zqa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P79_sm_gq_zqa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P79_sm_gq_zqa(); 
    ...
    virtual string name() const {return "gq_zqa (sm)";}

    virtual int code() const {return 10879;}
  ...
  private:
    ...
    double matrix_8_gu_zua(); 
    double matrix_8_gd_zda(); 
    double matrix_8_gux_zuxa(); 
    double matrix_8_gdx_zdxa(); 
...
#endif  // PY8MEs_R8_P79_sm_gq_zqa_H
