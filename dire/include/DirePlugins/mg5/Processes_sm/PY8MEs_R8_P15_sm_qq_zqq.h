...
#ifndef PY8MEs_R8_P15_sm_qq_zqq_H
#define PY8MEs_R8_P15_sm_qq_zqq_H
...
class PY8MEs_R8_P15_sm_qq_zqq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P15_sm_qq_zqq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P15_sm_qq_zqq(); 
    ...
    virtual int code() const {return 10815;}
  ...
  private:
    ...
    double matrix_8_uu_zuu(); 
    double matrix_8_uux_zuux(); 
    double matrix_8_dd_zdd(); 
    double matrix_8_ddx_zddx(); 
    double matrix_8_uxux_zuxux(); 
    double matrix_8_dxdx_zdxdx(); 
    double matrix_8_ud_zud(); 
    double matrix_8_uux_zddx(); 
    double matrix_8_udx_zudx(); 
    double matrix_8_dux_zdux(); 
    double matrix_8_ddx_zuux(); 
    double matrix_8_uxdx_zuxdx(); 
    double matrix_8_uc_zuc(); 
    double matrix_8_us_zus(); 
    double matrix_8_uux_zccx(); 
    double matrix_8_uux_zssx(); 
    double matrix_8_ucx_zucx(); 
    double matrix_8_usx_zusx(); 
    double matrix_8_ds_zds(); 
    double matrix_8_dcx_zdcx(); 
    double matrix_8_ddx_zccx(); 
    double matrix_8_ddx_zssx(); 
    double matrix_8_dsx_zdsx(); 
    double matrix_8_uxcx_zuxcx(); 
    double matrix_8_uxsx_zuxsx(); 
    double matrix_8_dxsx_zdxsx(); 
    double matrix_8_us_zcd(); 
    double matrix_8_ucx_zdsx(); 
    double matrix_8_udx_zcsx(); 
    double matrix_8_dux_zscx(); 
    double matrix_8_dsx_zucx(); 
    double matrix_8_uxsx_zcxdx(); 
...
#endif  // PY8MEs_R8_P15_sm_qq_zqq_H
