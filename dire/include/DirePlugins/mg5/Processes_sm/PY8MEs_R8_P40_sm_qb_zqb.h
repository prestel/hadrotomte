...
#ifndef PY8MEs_R8_P40_sm_qb_zqb_H
#define PY8MEs_R8_P40_sm_qb_zqb_H
...
class PY8MEs_R8_P40_sm_qb_zqb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P40_sm_qb_zqb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P40_sm_qb_zqb(); 
    ...
    virtual string name() const {return "qb_zqb (sm)";}

    virtual int code() const {return 10840;}
  ...
  private:
    ...
    double matrix_8_ub_zub(); 
    double matrix_8_ubx_zubx(); 
    double matrix_8_db_zdb(); 
    double matrix_8_dbx_zdbx(); 
    double matrix_8_uxb_zuxb(); 
    double matrix_8_uxbx_zuxbx(); 
    double matrix_8_dxb_zdxb(); 
    double matrix_8_dxbx_zdxbx(); 
...
#endif  // PY8MEs_R8_P40_sm_qb_zqb_H
