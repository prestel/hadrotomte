...
#ifndef PY8MEs_R8_P4_sm_bb_zbb_H
#define PY8MEs_R8_P4_sm_bb_zbb_H
...
class PY8MEs_R8_P4_sm_bb_zbb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P4_sm_bb_zbb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P4_sm_bb_zbb(); 
    ...
    virtual string name() const {return "bb_zbb (sm)";}

    virtual int code() const {return 10804;}
  ...
  private:
    ...
    double matrix_8_bb_zbb(); 
    double matrix_8_bbx_zbbx(); 
    double matrix_8_bxbx_zbxbx(); 
...
#endif  // PY8MEs_R8_P4_sm_bb_zbb_H
