...
#ifndef PY8MEs_R5_P73_sm_gq_qaa_H
#define PY8MEs_R5_P73_sm_gq_qaa_H
...
class PY8MEs_R5_P73_sm_gq_qaa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P73_sm_gq_qaa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P73_sm_gq_qaa(); 
    ...
    virtual string name() const {return "gq_qaa (sm)";}

    virtual int code() const {return 10573;}
  ...
  private:
    ...
    double matrix_5_gu_uaa(); 
    double matrix_5_gd_daa(); 
    double matrix_5_gux_uxaa(); 
    double matrix_5_gdx_dxaa(); 
...
#endif  // PY8MEs_R5_P73_sm_gq_qaa_H
