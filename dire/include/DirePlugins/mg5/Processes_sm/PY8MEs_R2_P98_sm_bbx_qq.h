...
#ifndef PY8MEs_R2_P98_sm_bbx_qq_H
#define PY8MEs_R2_P98_sm_bbx_qq_H
...
class PY8MEs_R2_P98_sm_bbx_qq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P98_sm_bbx_qq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P98_sm_bbx_qq(); 
    ...
    virtual string name() const {return "bbx_qq (sm)";}

    virtual int code() const {return 10298;}
  ...
  private:
    ...
    double matrix_2_bbx_uux(); 
    double matrix_2_bbx_ddx(); 
...
#endif  // PY8MEs_R2_P98_sm_bbx_qq_H
