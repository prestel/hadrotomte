...
#ifndef PY8MEs_R2_P105_sm_qq_aa_H
#define PY8MEs_R2_P105_sm_qq_aa_H
...
class PY8MEs_R2_P105_sm_qq_aa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P105_sm_qq_aa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P105_sm_qq_aa(); 
    ...
    virtual string name() const {return "qq_aa (sm)";}

    virtual int code() const {return 10305;}
  ...
  private:
    ...
    double matrix_2_uux_aa(); 
    double matrix_2_ddx_aa(); 
...
#endif  // PY8MEs_R2_P105_sm_qq_aa_H
