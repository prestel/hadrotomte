...
#ifndef PY8MEs_R7_P0_sm_bb_llbb_H
#define PY8MEs_R7_P0_sm_bb_llbb_H
...
class PY8MEs_R7_P0_sm_bb_llbb : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R7_P0_sm_bb_llbb(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R7_P0_sm_bb_llbb(); 
    ...
    virtual string name() const {return "bb_llbb (sm)";}

    virtual int code() const {return 10707;}
  ...
  private:
    ...
    static const int nwavefuncs = 161; 
    Complex<double> w[nwavefuncs][18]; 
    static const int namplitudes = 372; 
    Complex<double> amp[namplitudes]; 
    double matrix_7_bb_emepbb(); 
    double matrix_7_bbx_emepbbx(); 
    double matrix_7_bxbx_emepbxbx(); 
    double matrix_7_bb_vevexbb(); 
    double matrix_7_bbx_vevexbbx(); 
    double matrix_7_bxbx_vevexbxbx(); 
...
#endif  // PY8MEs_R7_P0_sm_bb_llbb_H
