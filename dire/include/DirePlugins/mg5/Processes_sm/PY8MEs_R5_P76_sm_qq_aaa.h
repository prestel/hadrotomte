...
#ifndef PY8MEs_R5_P76_sm_qq_aaa_H
#define PY8MEs_R5_P76_sm_qq_aaa_H
...
class PY8MEs_R5_P76_sm_qq_aaa : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R5_P76_sm_qq_aaa(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R5_P76_sm_qq_aaa(); 
    ...
    virtual string name() const {return "qq_aaa (sm)";}

    virtual int code() const {return 10576;}
  ...
  private:
    ...
    double matrix_5_uux_aaa(); 
    double matrix_5_ddx_aaa(); 
...
#endif  // PY8MEs_R5_P76_sm_qq_aaa_H
