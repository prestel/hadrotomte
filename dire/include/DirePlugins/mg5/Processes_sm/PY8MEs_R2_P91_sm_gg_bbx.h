...
#ifndef PY8MEs_R2_P91_sm_gg_bbx_H
#define PY8MEs_R2_P91_sm_gg_bbx_H
...
class PY8MEs_R2_P91_sm_gg_bbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R2_P91_sm_gg_bbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R2_P91_sm_gg_bbx(); 
    ...
    virtual int code() const {return 10291;}
...
#endif  // PY8MEs_R2_P91_sm_gg_bbx_H
