...
#ifndef PY8MEs_R6_P108_sm_gq_wpq_H
#define PY8MEs_R6_P108_sm_gq_wpq_H
...
class PY8MEs_R6_P108_sm_gq_wpq : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R6_P108_sm_gq_wpq(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R6_P108_sm_gq_wpq(); 
    ...
    virtual string name() const {return "gq_wpq (sm)";}
  ...
  private:
    ...
    double matrix_6_gu_wpd(); 
    double matrix_6_gd_wmu(); 
    double matrix_6_gux_wmdx(); 
    double matrix_6_gdx_wpux(); 
...
#endif  // PY8MEs_R6_P108_sm_gq_wpq_H
