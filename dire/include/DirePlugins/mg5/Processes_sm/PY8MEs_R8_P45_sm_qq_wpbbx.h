...
#ifndef PY8MEs_R8_P45_sm_qq_wpbbx_H
#define PY8MEs_R8_P45_sm_qq_wpbbx_H
...
class PY8MEs_R8_P45_sm_qq_wpbbx : public PY8ME
{
  public:
    ...
    // Constructor.
    PY8MEs_R8_P45_sm_qq_wpbbx(Parameters_sm * model) : pars(model) {initProc();}

    // Destructor.
    ~PY8MEs_R8_P45_sm_qq_wpbbx(); 
    ...
    virtual string name() const {return "qq_wpbbx (sm)";}

    virtual int code() const {return 10845;}
  ...
  private:
    ...
    double matrix_8_udx_wpbbx(); 
    double matrix_8_dux_wmbbx(); 
...
#endif  // PY8MEs_R8_P45_sm_qq_wpbbx_H
