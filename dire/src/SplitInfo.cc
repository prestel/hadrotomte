...
void DireSplitInfo::restore () {
  ...
  checkCuts = checkCutsStore;
  iSiblings       = iSiblingsStore;
}

void DireSplitInfo::storeInfo(string name, int typeIn, int systemIn, int systemRecIn, 
  ...
  //storeExtras(
  // unordered_map<string,double>(create_unordered_map<string,double>("iRadBef",iPosRadBef)
