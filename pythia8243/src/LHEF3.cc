...
bool Writer::writeEvent(HEPEUP * peup, int pDigits) {
  ...
  file << scientific << setprecision(pDigits);
  ...
  for ( int i = 0; i < eup.NUP; ++i )
    file << " " << setw(8) << eup.IDUP[i]
         ...
         << " " << setw(pDigits+10) << eup.PUP[i][0]
         << " " << setw(pDigits+10) << eup.PUP[i][1]
         << " " << setw(pDigits+10) << eup.PUP[i][2]
         << " " << setw(pDigits+10) << eup.PUP[i][3]
         << " " << setw(pDigits+10) << eup.PUP[i][4]
         << " " << setw(1) << eup.VTIMUP[i]
